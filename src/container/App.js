	...
	render() {
		...
		return (
			<RctThemeProvider>
				...
				{/*<Route path="/login" render={(routeProps) => (<AsynAdminLoginComponent {...routeProps} cookies={cookies} />)} />}*/}

				<Route path="/login" component={AsynAdminLoginComponent} />
				<Route path="/forgot" component={AsynForgetPasswordComponent} />
				<Route path="/resetpassword/:token" component={AsynResetPasswordComponent} />
			</RctThemeProvider>
		);
	}
}
...
const mapStateToProps = ({ authUser }) => {
	authUser = { user: "K5P8TtvNZOXnRyjNHuxkrYZLV4z1" };
	const { user } = authUser;
