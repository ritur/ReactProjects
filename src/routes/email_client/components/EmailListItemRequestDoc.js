...
const EmailListItemRequestDoc = ({ email, emailTo,myid, myusername, emailFrom, onSelectEmail, handleMarkAsStar, onReadEmail, getTaskLabelNames }) => (
...
export default EmailListItemRequestDoc;
