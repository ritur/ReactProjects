...
import RequestedDocHeader from './RequestedDocHeader';
				...
				>
					<React.Fragment>
						...
						<Switch>
							...
							<Route path={`${match.url}/archive`} component={ArchiveEmails} />
							<Route path={`${match.url}/requested`} component={RequestedDocHeader} />
						</Switch>
					</React.Fragment>
				</Scrollbars>
			</div>
