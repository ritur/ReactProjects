...
export default class ForwordComponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            to: [],
    ...
    componentDidMount() {
        ...
        this.setState({ message: this.props.makeForwordFormdata.message }) //store props data into message fields for forword
        ...
        $(document).ready(function () {
            ...
            // $('.PowerSelect__TriggerInput').trigger('click');
            // $(document).on('click', '.PowerSelect__TriggerInput',function () {
            //     if($(this).val()==""){
            //         $('.PowerSelect__Options').hide();
            //     }
        ...
        console.log('makeForwordFormdata iisssssssssssssssssssssssss', this.props.makeForwordFormdata)
    }
    margeAllRecipient() {
    ...
    handlePrivateSubmit = (e) => {
        ...
        const { makeForwordFormdata } = this.props;
        let subject = makeForwordFormdata.subject,
            mail_type = makeForwordFormdata.mail_type,
            type = 'Forword';
        const { froms, message } = this.state;
        axios.post(BaseUrl +'api/composemail', { to, froms, type, mail_type, subject, message }) //API FOR INSERT
            .then((result) => {
                this.setState({
                    snackbar: true,
                    sectionReload: false,
