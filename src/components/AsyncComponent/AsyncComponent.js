...
// FOR EMAIL DASHBOARD
const AsyncEmailClientDashboardComponent = Loadable({
	loader: () =>
		import ("Routes/email_client"),
	loading: () => < RctPageLoader / > ,
});

// FOR LOGIN
const AsynAdminLoginComponent = Loadable({
	loader: () =>
		import ("Routes/email_client/userCredentials/login"),
	loading: () => < RctPageLoader / > ,
});
// FOR FORGET PASSWORD FORM
const AsynForgetPasswordComponent = Loadable({
	loader: () =>
		import ("Routes/email_client/userCredentials/forgetPassword"),
	loading: () => < RctPageLoader / > ,
});
// FOR RESET PASSWORD
const AsynResetPasswordComponent = Loadable({
	loader: () =>
		import ("Routes/email_client/userCredentials/resetPassword"),
	loading: () => < RctPageLoader / > ,
});
// FOR RESET PASSWORD
const AsynUserProfileComponent = Loadable({
	loader: () =>
		import ("Routes/email_client/userCredentials/userprofile"),
	loading: () => < RctPageLoader / > ,
});

// FOR CREATE USERS
const AsynCreateUserComponent = Loadable({
	loader: () =>
		import("Routes/email_client/users/create_users"),
	loading: () => < RctPageLoader />,
});
// FOR MANAGE USERS
const AsynManageUserComponent = Loadable({
	loader: () =>
		import("Routes/email_client/users/manage_users"),
	loading: () => < RctPageLoader />,
});
// FOR MANAGE USERS
const AsynBinUserComponent = Loadable({
	loader: () =>
		import("Routes/email_client/users/bin_users"),
	loading: () => < RctPageLoader />,
});

// FOR CREATE GROUP
const AsynCreateGroupComponent = Loadable({
	loader: () =>
		import("Routes/email_client/groups/create_group"),
	loading: () => < RctPageLoader />,
});
// FOR MANAGE GROUP
const AsynManageGroupComponent = Loadable({
	loader: () =>
		import("Routes/email_client/groups/manage_group"),
	loading: () => < RctPageLoader />,
});
// FOR BIN GROUP
const AsynBinGroupComponent = Loadable({
	loader: () =>
		import("Routes/email_client/groups/bin_group"),
	loading: () => < RctPageLoader />,
});
export {
	...
	AsyncEmailClientDashboardComponent,
	AsynAdminLoginComponent,
	AsynForgetPasswordComponent,
	AsynResetPasswordComponent,
	AsynUserProfileComponent,
